...
| `Capability` | What an account can do on the repository | Closed set of three: `push`, `merge`, `approve`. Detected from the backend, never declared — the input to role derivation ([resolution.md](resolution.md) § Accounts, capabilities and roles). |
