...
func gitInTest(t *testing.T, dir string, args ...string) string {
	...
	cmd.Dir = dir
	// A dotless domain: the commit guard refuses anything address-shaped, and
	// `test@test` is the placeholder the rest of this package already uses.
