...
func (b *Backend) rawArtifactURL(path string) string {
...
func (b *Backend) putArtifactFile(ctx context.Context, path string, content []byte, commitMessage string) (rawURL string, err error) {
